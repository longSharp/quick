...
import com.quick.gpt.config.ChatGPTProperties;
import com.quick.gpt.dto.Billing;
import com.quick.gpt.dto.Subscription;
import com.quick.gpt.enums.chat.FinishReasonEnum;
...
import com.quick.gpt.enums.image.ImageResponseFormatEnum;
import com.quick.gpt.enums.image.ImageSizeEnum;
...
public class OpenAiProxyService extends OpenAiService {
    ...
    public ChatMessage createStreamChatCompletionForResp(List<ChatMessage> messagesList, String user, OutputStream os) {
        return createStreamChatCompletionForResp(ChatCompletionRequest.builder()
                .model(chatGPTProperties.getChatModel())
    ...
    public ChatMessage createStreamChatCompletionForResp(ChatCompletionRequest chatCompletionRequest, OutputStream os){
...
//                    chatCompletionRequest.setMessages(cache.getIfPresent(user));
                    throw new ChatGPTException(ChatGPTErrorEnum.LENGTH_ERROR, message);
                }
        ...
        return new ChatMessage(RoleEnum.ASSISTANT.getRoleName(), chunks.stream()
