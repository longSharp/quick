...
public class OpenAiUtils {
    ...
    public static ChatMessage createStreamChatCompletionForResp(List<ChatMessage> messagesList, String user, OutputStream os) {
        return openAiProxyService.createStreamChatCompletionForResp(messagesList, user, os);
    }
